...
public class QueriesProvider {
    ...
    public static String SEARCH_BY_DIRECTOR = "(SELECT * FROM films f WHERE f.film_id IN " +
    ...
    public static String SEARCH_BY_TITLE = "SELECT * FROM films f WHERE LOWER (f.name) LIKE '%%%s%%'";
